select
    ...
    gr.post,
    lev.level as level,
    COALESCE(pay.rate, pay2.rate)/12 as RateInHour, -- Ставка в час
    COALESCE(pay.rate, pay2.rate)/12 * -- Ставка за смену
