...
LEFT JOIN analyticdb.zpr_payconditions as pay ON cl.ref_key = pay.clinic_ref       AND ifnull (gr.post, 'Самозванец') = pay.post     AND s.period >= pay.date_from and s.period < pay.date_end
