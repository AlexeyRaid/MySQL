select gr.clinic,
       ...
       gr.role,
       gr.shift,
       TIME_FORMAT(gr.time_start, '%H:%i')                as TStart,
       TIME_FORMAT(gr.time_end, '%H:%i')                  as TEnd,
...
select cor.clinic,
       ...
       cor.role,
       cor.shift,
       TIME_FORMAT(cor.DTStart, '%H:%i') as TStart,
       TIME_FORMAT(cor.DTEnd, '%H:%i')   as TEnd,
       cor.shift_date,
       cor.DlSmen,
       '1'
